...
static produceLayoutFile(){
    ...
    produceSectionSix(file,    "06", 0x044010, 0x09B000, 0x09B000-0x09AC6C, "0x044010..0x09B000 : To figure out and describe succinctly");
    ...
    produceGenericSection(file,"10", 0x1A4400, 0x1AF800, 0x1AF800-0x1AF5FA, "0x1A4400..0x1AF800 : To figure out and describe succinctly");
...
static produceSpecificSectionOne(mainFile,sectionName,start,end,fs,sectionComment){
    auto ea,itemSize,action,currentLine,previousLine,fileName,file;
    auto output, name, indent, comment, commentEx, commentIndent;
    fileName = form("layout\\ls-%s-0x00000%s-0x00%s.asm",sectionName,ltoa(start,16),ltoa(end,16));
    Message(form("Writing assembly section %s to %s (%s) ... ",sectionName,fileName,sectionComment));    
    action = 1;
    writestr(mainFile,form("                include \"%s\"    ; %s\n",fileName,sectionComment));
    file = fopen(form("disasm\\%s",fileName),"w");
...
static produceSpecificSectionTwo(mainFile,sectionName,start,end,fs,sectionComment){
    auto ea,itemSize,action,currentLine,previousLine,fileName,file;
    auto output, name, indent, comment, commentEx, commentIndent;
    fileName = form("layout\\ls-%s-0x00%s-0x0%s.asm",sectionName,ltoa(start,16),ltoa(end,16));
    Message(form("Writing assembly section %s to %s (%s) ... ",sectionName,fileName,sectionComment));    
    action = 1;
    writestr(mainFile,form("                include \"%s\"    ; %s\n",fileName,sectionComment));
    file = fopen(form("disasm\\%s",fileName),"w");
...
static produceSpecificSectionSeven(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\pointertable_261",0x50B00,0x50B18,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\pointertable_1FA",0x50B18,0x50B30,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s1_entities",0x50B30,0x50BCA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s1_entities_261",0x50BCA,0x50CCA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s1_entities_1FA",0x50CCA,0x50D4C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s3_zoneevents",0x50D4C,0x50EEA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s3_zoneevents_261",0x50EEA,0x50F0C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s3_zoneevents_1FA",0x50F0C,0x50F10,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s2_entityevents",0x50F10,0x5105C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s2_entityevents_261",0x5105C,0x511CA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s2_entityevents_1FA",0x511CA,0x512E0,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s6_initfunction_1FA",0x51360,0x51382,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s6_initfunction",0x51382,0x513C0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s6_initfunction_261",0x513C0,0x513D6,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\pointertable_28A",0x5192A,0x51942,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s1_entities",0x51942,0x519C4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s1_entities_28A",0x519C4,0x51A3E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s2_entityevents",0x51A3E,0x51A82,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s2_entityevents_28A",0x51A82,0x51C22,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\pointertable_297",0x51C5E,0x51C76,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\pointertable",0x51C76,0x51C8E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s1_entities_297",0x51C8E,0x51D30,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s1_entities",0x51D30,0x51DE2,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s2_entityevents_297",0x51DE2,0x51E32,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\pointertable_1F9",0x5229C,0x522B4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s1_entities",0x522B4,0x522DC,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s1_entities_1F9",0x522DC,0x5231C,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s3_zoneevents_1F9",0x52442,0x52446,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\pointertable_1F5",0x52B62,0x52B7A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\pointertable_261",0x52B7A,0x52B92,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\pointertable_1FA",0x52B92,0x52BAA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\pointertable_1FB",0x52BAA,0x52BC2,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s1_entities",0x52BC2,0x52C2C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s1_entities_1F5",0x52C2C,0x52C46,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s1_entities_261",0x52C46,0x52CB0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s1_entities_1FA",0x52CB0,0x52D8A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s1_entities_1FB",0x52D8A,0x52D94,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s3_zoneevents",0x52D94,0x52D98,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s3_zoneevents_1FA",0x52D98,0x52DA4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s3_zoneevents_1FB",0x52DA4,0x52E02,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s2_entityevents",0x52E02,0x52F60,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s2_entityevents_1F5",0x52F60,0x52F90,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s2_entityevents_261",0x52F90,0x5301C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s2_entityevents_1FA",0x5301C,0x530BA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s2_entityevents_1FB",0x530BA,0x530BE,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s6_initfunction_261",0x5310C,0x5311E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s6_initfunction_1FA",0x5311E,0x53168,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s6_initfunction_1FB",0x53168,0x53176,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\pointertable_1F5",0x5364C,0x53664,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\pointertable_261",0x53664,0x5367C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\pointertable_1FA",0x5367C,0x53694,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s1_entities",0x53694,0x536D6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s1_entities_1F5",0x536D6,0x53720,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s1_entities_261",0x53720,0x53760,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s1_entities_1FA",0x53760,0x53762,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s3_zoneevents",0x53762,0x53766,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s3_zoneevents_1F5",0x53766,0x537AC,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s2_entityevents",0x537AC,0x53830,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s2_entityevents_1F5",0x53830,0x538B4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s2_entityevents_261",0x538B4,0x53928,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s2_entityevents_1FA",0x53928,0x5392C,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\pointertable_1F5",0x53E30,0x53E48,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\pointertable_261",0x53E48,0x53E60,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\pointertable_1FA",0x53E60,0x53E78,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s1_entities",0x53E78,0x53E82,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s1_entities_261",0x53E82,0x53E8A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s1_entities_1FA",0x53E8A,0x53E8C,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s2_entityevents_1F5",0x53E9A,0x53EA2,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s2_entityevents_261",0x53EA2,0x53EAA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s2_entityevents_1FA",0x53EAA,0x53F06,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map40\\mapsetups\\pointertable_1FA",0x53F48,0x53F60,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map40\\mapsetups\\pointertable",0x53F60,0x53F78,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map40\\mapsetups\\s1_entities_1FA",0x53F78,0x53F90,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map43\\mapsetups\\pointertable_264",0x54016,0x5402E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map43\\mapsetups\\s1_entities",0x5402E,0x54046,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map43\\mapsetups\\s1_entities_264",0x54046,0x54048,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\pointertable_261",0x54360,0x54378,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\pointertable_1FA",0x54378,0x54390,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\pointertable_1FB",0x54390,0x543A8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s1_entities",0x543A8,0x543BA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s1_entities_261",0x543BA,0x543E4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s1_entities_1FA",0x543E4,0x543EE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s1_entities_1FB",0x543EE,0x54458,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s2_entityevents_261",0x5446A,0x54482,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s2_entityevents_1FA",0x54482,0x5448A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s2_entityevents_1FB",0x5448A,0x5455E,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\s6_initfunction_1FB",0x54568,0x54578,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map44\\mapsetups\\scripts",0x54578,0x5473E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\pointertable_2BE",0x5473E,0x54756,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\pointertable",0x54756,0x5476E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\pointertable_2BD",0x5476E,0x54786,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s1_entities_2BE",0x54786,0x547F8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s1_entities",0x547F8,0x5489A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s1_entities_2BD",0x5489A,0x5490C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s2_entityevents_2BE",0x5490C,0x54948,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s2_entityevents",0x54948,0x54984,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s2_entityevents_2BD",0x54984,0x54CD0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s3_zoneevents",0x54CD0,0x54D3C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map06\\mapsetups\\s4_descriptions_2BE",0x54D3C,0x54D8A,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\pointertable_2BD",0x55396,0x553AE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\pointertable_325",0x553AE,0x553C6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\s1_entities",0x553C6,0x55428,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\s1_entities_2BD",0x55428,0x554B2,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\s1_entities_325",0x554B2,0x5550C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\s2_entityevents",0x5550C,0x55540,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\s2_entityevents_2BD",0x55540,0x55584,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map07\\mapsetups\\s2_entityevents_325",0x55584,0x5579E,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map08\\mapsetups\\pointertable_2C4",0x55F8E,0x55FA6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map08\\mapsetups\\pointertable",0x55FA6,0x55FC4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map08\\mapsetups\\s1_entities_2C4",0x55FC4,0x56036,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map08\\mapsetups\\s1_entities",0x56036,0x56048,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map08\\mapsetups\\s2_entityevents_2C4",0x56048,0x56084,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map09\\mapsetups\\pointertable_206",0x5664E,0x56666,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map09\\mapsetups\\s1_entities",0x56666,0x566C0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map09\\mapsetups\\s1_entities_206",0x566C0,0x56722,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\pointertable_2D2",0x56B9C,0x56BB4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\s1_entities",0x56BB4,0x56CA6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\s1_entities_2D2",0x56CA6,0x56D80,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\s2_entityevents",0x56D80,0x56E9C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\s2_entityevents_2D2",0x56E9C,0x56F8A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\s3_zoneevents",0x56F8A,0x56FC0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\s3_zoneevents_2D2",0x56FC0,0x56FE0,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map10\\mapsetups\\s6_initfunction_2D2",0x5708E,0x570B0,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\pointertable_2C6",0x57E4E,0x57E66,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\pointertable_31F",0x57E66,0x57E7E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\pointertable_201",0x57E7E,0x57E96,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\s1_entities",0x57E96,0x57F08,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\s1_entities_2C6",0x57F08,0x57F7A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\s1_entities_31F",0x57F7A,0x57FB4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\s1_entities_201",0x57FB4,0x5801E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\s2_entityevents",0x5801E,0x5814C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map13\\mapsetups\\s2_entityevents_201",0x5814C,0x5822A,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map14\\mapsetups\\pointertable_1CA",0x58E30,0x58E48,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map14\\mapsetups\\s1_entities_1CA",0x58F2A,0x58F3C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map14\\mapsetups\\s2_entityevents_1CA",0x58F3C,0x58F4C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map14\\mapsetups\\s3_zoneevents_1CA",0x58F4C,0x58F5C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map14\\mapsetups\\scripts_1",0x58F5C,0x58F9A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map14\\mapsetups\\s6_initfunction_1CA",0x58F9A,0x58F9C,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map22\\mapsetups\\pointertable_20A",0x592F8,0x59310,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map22\\mapsetups\\s1_entities",0x59310,0x59402,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map22\\mapsetups\\s1_entities_20A",0x59402,0x59474,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map23\\mapsetups\\pointertable_2FA",0x59AD8,0x59AF0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map23\\mapsetups\\s1_entities",0x59AF0,0x59B22,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map23\\mapsetups\\s1_entities_2FA",0x59B22,0x59B44,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map23\\mapsetups\\s2_entityevents",0x59B44,0x59BA8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map23\\mapsetups\\s2_entityevents_2FA",0x59BA8,0x59BD2,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map27\\mapsetups\\pointertable_20B",0x59F5A,0x59F72,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map27\\mapsetups\\s1_entities",0x59F72,0x59F8A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map27\\mapsetups\\s1_entities_20B",0x59F8A,0x59F8C,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map30\\mapsetups\\pointertable_311",0x5A18E,0x5A1A6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map30\\mapsetups\\pointertable_2F9",0x5A1A6,0x5A1BE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map30\\mapsetups\\s1_entities",0x5A1BE,0x5A1E0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map30\\mapsetups\\s1_entities_311",0x5A1E0,0x5A20A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map30\\mapsetups\\s1_entities_2F9",0x5A20A,0x5A20C,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\pointertable_20B",0x5A65E,0x5A676,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\pointertable_310",0x5A676,0x5A68E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\pointertable_312",0x5A68E,0x5A6A6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\s1_entities",0x5A6A6,0x5A6D8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\s1_entities_20B",0x5A6D8,0x5A712,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\s1_entities_310",0x5A712,0x5A74C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\s1_entities_312",0x5A74C,0x5A766,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map33\\mapsetups\\s6_initfunction_312",0x5AC56,0x5AC58,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map34\\mapsetups\\pointertable_310",0x5B5CE,0x5B5E6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map34\\mapsetups\\s1_entities",0x5B5E6,0x5B68E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map34\\mapsetups\\s1_entities_310",0x5B68E,0x5B690,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map51\\mapsetups\\pointertable_208",0x5C294,0x5C2AC,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map51\\mapsetups\\s1_entities",0x5C2AC,0x5C2CE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map51\\mapsetups\\s1_entities_208",0x5C2CE,0x5C2D0,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map52\\mapsetups\\pointertable_200",0x5C46C,0x5C484,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map52\\mapsetups\\s1_entities",0x5C484,0x5C4A6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map52\\mapsetups\\s1_entities_200",0x5C4A6,0x5C4A8,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map61\\mapsetups\\pointertable_2D9",0x5C638,0x5C650,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map61\\mapsetups\\s1_entities_2D9",0x5C670,0x5C672,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map62\\mapsetups\\pointertable_4D",0x5C782,0x5C79A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map62\\mapsetups\\s1_entities",0x5C79A,0x5C7AC,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map62\\mapsetups\\s1_entities_4D",0x5C7AC,0x5C7B6,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map63\\mapsetups\\pointertable_1D",0x5C950,0x5C968,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map63\\mapsetups\\s1_entities_1D",0x5C988,0x5C98A,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map15\\mapsetups\\pointertable_212",0x5CE16,0x5CE2E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map15\\mapsetups\\s1_entities",0x5CE2E,0x5CE90,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map15\\mapsetups\\s1_entities_212",0x5CE90,0x5CEEA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map15\\mapsetups\\s2_entityevents",0x5CEEA,0x5CF9E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map15\\mapsetups\\s2_entityevents_212",0x5CF9E,0x5CFFA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map15\\mapsetups\\s3_zoneevents",0x5CFFA,0x5CFFE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map15\\mapsetups\\s3_zoneevents_212",0x5CFFE,0x5D020,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\pointertable_33E",0x5D426,0x5D43E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s1_entities",0x5D43E,0x5D440,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s1_entities_33E",0x5D440,0x5D49A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s2_entityevents",0x5D49A,0x5D49E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s2_entityevents_33E",0x5D49E,0x5D552,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s3_zoneevents",0x5D552,0x5D556,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s3_zoneevents_33E",0x5D556,0x5D574,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s5_itemevents_33E",0x5D614,0x5D61C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s6_initfunction",0x5D61C,0x5D61E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map31\\mapsetups\\s6_initfunction_33E",0x5D61E,0x5D644,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map36\\mapsetups\\pointertable_212",0x5D76E,0x5D786,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map36\\mapsetups\\s1_entities",0x5D786,0x5D7F0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map36\\mapsetups\\s1_entities_212",0x5D7F0,0x5D84A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map36\\mapsetups\\s2_entityevents",0x5D84A,0x5D924,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map36\\mapsetups\\s2_entityevents_212",0x5D924,0x5D9C0,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map39\\mapsetups\\pointertable_33E",0x5DF9C,0x5DFB4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map39\\mapsetups\\s1_entities",0x5DFB4,0x5DFFE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map39\\mapsetups\\s1_entities_33E",0x5DFFE,0x5E038,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map39\\mapsetups\\s3_zoneevents_33E",0x5E0CE,0x5E0D4,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map39\\mapsetups\\s6_initfunction_33E",0x5E0E0,0x5E0F8,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map02\\mapsetups\\pointertable_212",0x5E884,0x5E89C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map02\\mapsetups\\s1_entities",0x5E89C,0x5E8EE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map02\\mapsetups\\s1_entities_212",0x5E8EE,0x5E938,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map02\\mapsetups\\s2_entityevents",0x5E938,0x5E9C8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map02\\mapsetups\\s2_entityevents_212",0x5E9C8,0x5EA20,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map02\\mapsetups\\s4_descriptions_212",0x5EA62,0x5EA9E,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map37\\mapsetups\\pointertable_3E7",0x5F660,0x5F678,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map37\\mapsetups\\s1_entities",0x5F678,0x5F772,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map37\\mapsetups\\s1_entities_3E7",0x5F772,0x5F86C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map37\\mapsetups\\s2_entityevents",0x5F86C,0x5F9D2,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map37\\mapsetups\\s2_entityevents_3E7",0x5F9D2,0x5FA22,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map37\\mapsetups\\s6_initfunction_3E7",0x5FAA4,0x5FB30,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\pointertable_212",0x603AE,0x603C6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\pointertable_1C",0x603C6,0x603DE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s1_entities_212",0x603DE,0x60410,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s1_entities_1C",0x60410,0x6043A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s2_entityevents_212",0x6043A,0x604C8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s3_zoneevents_212",0x604C8,0x60548,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s4_descriptions_212",0x60548,0x60606,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s5_itemevents_212",0x60606,0x6060E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\scripts_2",0x6060E,0x6061E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\s6_initfunction_212",0x6061E,0x60708,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map05\\mapsetups\\scripts_1",0x60708,0x60FAE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\pointertable_212",0x60FAE,0x60FC6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s1_entities_212",0x60FC6,0x61058,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s2_entityevents_212",0x61058,0x6114E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s3_zoneevents_212",0x6114E,0x61154,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s4_descriptions_212",0x61154,0x6119C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s5_itemevents_212",0x6119C,0x611A4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map16\\mapsetups\\s6_initfunction_212",0x611A4,0x611A6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\pointertable_212",0x611A6,0x611BE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s1_entities_212",0x611BE,0x611E0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s2_entityevents_212",0x611E0,0x61208,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s3_zoneevents_212",0x61208,0x6120E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s4_descriptions_212",0x6120E,0x61210,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s5_itemevents_212",0x61210,0x61218,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map17\\mapsetups\\s6_initfunction_212",0x61218,0x6121A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map18\\mapsetups\\pointertable_212",0x6121A,0x61232,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map18\\mapsetups\\s1_entities_212",0x61232,0x61254,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map18\\mapsetups\\s2_entityevents_212",0x61254,0x6125A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map18\\mapsetups\\s3_zoneevents_212",0x6125A,0x61278,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map18\\mapsetups\\s4_descriptions_212",0x61278,0x61290,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map18\\mapsetups\\s5_itemevents_212",0x61290,0x61298,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map18\\mapsetups\\s6_initfunction_212",0x61298,0x6143C,"");
    ...
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map59\\mapsetups\\pointertable_21F",0x6153E,0x61556,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map59\\mapsetups\\s1_entities_21F",0x61556,0x615B0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map59\\mapsetups\\s2_entityevents_21F",0x615B0,0x615B6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map59\\mapsetups\\s3_zoneevents_21F",0x615B6,0x615CE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map59\\mapsetups\\s4_descriptions_21F",0x615CE,0x615D0,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map59\\mapsetups\\s5_itemevents_21F",0x615D0,0x615D8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map59\\mapsetups\\s6_initfunction_21F",0x615D8,0x626A6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\pointertable_21F",0x626A6,0x626BE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s1_entities_21F",0x626BE,0x62738,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s2_entityevents_21F",0x62738,0x62820,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s3_zoneevents_21F",0x62820,0x62846,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s4_descriptions_21F",0x62846,0x628BE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s5_itemevents_21F",0x628BE,0x628C6,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\s6_initfunction_21F",0x628C6,0x628C8,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map03\\mapsetups\\scripts_2",0x628C8,0x6299A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\pointertable_21F",0x6299A,0x629B2,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\pointertable_3D6",0x629B2,0x629CA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s1_entities_21F",0x629CA,0x62A6C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s1_entities_3D6",0x62A6C,0x62AFE,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s2_entityevents_21F",0x62AFE,0x62BCA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s2_entityevents_3D6",0x62BCA,0x62C6C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s3_zoneevents_21F",0x62C6C,0x62C72,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s4_descriptions_21F",0x62C72,0x62C96,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s5_itemevents_21F",0x62C96,0x62C9E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map19\\mapsetups\\s6_initfunction_21F",0x62C9E,0x631EA,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\pointertable_21F",0x631EA,0x63202,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s1_entities_21F",0x63202,0x63234,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s2_entityevents_21F",0x63234,0x6329A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s3_zoneevents_21F",0x6329A,0x63364,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s4_descriptions_21F",0x63364,0x6339A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s5_itemevents_21F",0x6339A,0x633A2,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\s6_initfunction_21F",0x633A2,0x633C4,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map20\\mapsetups\\scripts_2",0x633C4,0x6343C,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\pointertable_21F",0x6343C,0x63454,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s1_entities_21F",0x63454,0x6345E,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s2_entityevents_21F",0x6345E,0x63472,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s3_zoneevents_21F",0x63472,0x63478,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s4_descriptions_21F",0x63478,0x6347A,"");
    produceAsmScript(mapSetupsFile,"data\\maps\\entries\\map21\\mapsetups\\s5_itemevents_21F",0x6347A,0x63482,"");
...
static produceSpecificSectionSeventeen(mainFile,sectionName,start,end,fs,sectionComment){
    ...
    writestr(file,"                if (FULL_CLASS_NAMES=1)\n");
    writestr(file,"                include \"data\\stats\\allies\\classes\\fullclassnames.asm\"\n");
