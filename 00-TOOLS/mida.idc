...
static main() {
  ...
  SegCreate(0x000000,0x200000,0,1,0,2);
  SegRename(0x000000,"ROM");

  SegCreate(0xA00000,0xA10000,0,1,0,2);
  SegRename(0xA00000,"Z80");

  SegCreate(0xA10000,0xA11000,0,1,0,2);
  SegRename(0xA10000,"IO");

  SegCreate(0xA11000,0xA12000,0,1,0,2);
  SegRename(0xA11000,"Control");

  SegCreate(0xC00000,0xC00012,0,1,0,2);
  SegRename(0xC00000,"VDP");

  SegCreate(0xFF0000,0x1000000,0,1,0,2);
  SegRename(0xFF0000,"RAM");

  SegCreate(0x200000,0x204000,0,1,0,2);
